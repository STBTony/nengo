...
class CosineSimilarity(SubvectorLength):
    ...
    Furthermore, ``CosineSimilarity(d+2)`` is equivalent to the distribution of a
    single coordinate from points uniformly samples from the d-dimensional unit
    ball (a single dimension of
    ...
    .. [Voelker2017]
       ...
       2017
       <https://www.researchgate.net/publication/312056739_Efficiently_sampling_vectors_and_coordinates_from_the_n-sphere_and_n-ball>`_,
